...
* Download remote images to local folder to utilize the power of Gatsby Images
...
We're on the half way to ﬁnish the neltify function
...
The GET request URL will be [your-netlify-wesbite/.netlify/functions/product-hunt]()
